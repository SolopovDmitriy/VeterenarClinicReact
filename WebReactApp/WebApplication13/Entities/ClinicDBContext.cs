...
namespace WebApplication13.Entities
{
    public class ClinicDBContext: DbContext
    {
        ...
        {
            //optionsBuilder.UseSqlServer(@"Server=tcp:simplewebreactapp-server.database.windows.net,1433;Initial Catalog=simplewebreactapp;Persist Security Info=False;User ID=simplewebreactapp-server-admin;Password=E86154WKW6RS23OI$;MultipleActiveResultSets=True;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;");
